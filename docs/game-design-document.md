...
`meta.difficulty` 1-3, 1:1 со шкалой в админ-конфиге). Глубина растёт с 6-7 ходов
(easy, один навык ≥2) до 10-11 ходов (hard, два-три навыка ≥2 одновременно). Каждый
файл — 25-30 узлов, гейты по навыкам распределены по всей длине разговора (27-40%
нетерминальных узлов), а не только у финального выбора.
...
- ⬜ **README / инструкция запуска** — сейчас в репозитории только автосозданная
  ...
  самостоятельно.
- ⬜ **Публичный хостинг WebGL-сборки** (itch.io / GitHub Pages / аналог) —
  сборка проверена локально, публичной ссылки ещё нет.
