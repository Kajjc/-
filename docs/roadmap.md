...
- Фактически достигнуто: easy 50/50 (100%) везде; medium 141-150/150 (94-100%); hard 167-179/300 (56-60%, честный недобор — предел ручного написания диалога за один заход без потери качества, всё равно ~15-17x рост от исходной глубины). Подробные цифры и гейты по каждому сюжету — `docs/eval-rubric.md` §5.
- ⬬ **Решение отложено**: добивать ли все четыре hard-файла ближе к буквальным 300 отдельным заходом (приём «хирургической вставки» под-эпизодов уже отработан и легко повторим), или остановиться на достигнутом — ждёт решения пользователя.
